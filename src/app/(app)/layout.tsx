    ...
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      <aside className="w-64 flex flex-col border-r border-border bg-card">
        <div className="flex h-16 shrink-0 items-center px-6">
          <span className="font-semibold text-lg tracking-tight">LIMA AI</span>
        </div>
        ...
        <div className="p-4 border-t border-border">
            <form action="/auth/signout" method="post">
                <button type="submit" className="flex w-full items-center gap-3 rounded-md px-3 py-2 text-sm font-medium text-muted-foreground hover:bg-muted hover:text-foreground transition-colors">
